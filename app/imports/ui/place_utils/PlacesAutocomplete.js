...
class PlacesAutocomplete extends React.Component {
  ...
  getActiveSuggestion = () => this.state.suggestions.find(suggestion => suggestion.active);
  ...
  getIsExpanded = () => this.state.suggestions.length > 0;
...
PlacesAutocomplete.defaultProps = {
  ...
  onError: (status, _clearSuggestions) => console.error(
